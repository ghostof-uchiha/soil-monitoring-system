...
import LoginDark from '../../images/logo/LoginDark.svg';
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img className="hidden dark:block mb-4" src={Login} alt="Logo" />
                <img className="dark:hidden" src={LoginDark} alt="Logo" />
              </Link>

              <p className="2xl:px-20">
                .....SIGN IN AND ENJOY OUR SERVICE.....
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Connect with us </span>
