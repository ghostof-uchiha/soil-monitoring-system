...
const Settings = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      formDataWithImage.append('mobileNumber', formData.mobileNumber);
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="relative mb-5.5 w-72 h-72 rounded-full block cursor-pointer appearance-none border-2 border-dashed border-primary bg-gray py-4 px-4 dark:bg-meta-4 sm:py-7.5">
                    <input
                      type="file"
                      accept="image/*"
                      className="absolute inset-0 z-50 m-0 h-full w-full rounded-full cursor-pointer p-0 opacity-0 outline-none"
                      name="profileImage"
                      onChange={handleInputChange}
                    />
