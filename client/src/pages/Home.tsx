...
const Home = () => {
    ...
    <div className ="mb-2 sm:mb-0 flex flex-row
      ">
        <div className ="h-10 w-10 self-center mb-4">
          <img className ="h-10 w-16 self-center" src="https://bytewebster.com/img/logo.png" />
        </div>
        <div>
          <a href="https://bytewebster.com/" className ="text-3xl no-underline text-blue-700 font-sans font-bold">Agro -<span className ="text-green-800">API</span></a><br/>
          <span className ="text-xs text-grey-dark">Grow your farming with agro!</span>
        </div>
      </div>
  ...
  <header className="relative flex pt-32 pb-48 sm:pt-32 sm:pb-64 lg:pb-48 px-4 bg-blue-100 w-full md:pb-40 lg:px-16 lg:pt-48 xl:pt-40 xl:pb-64 xl:h-screen md:px-8 xl:px-24 xxl:px-40">
    ...
    <div className="w-full absolute bottom-0 right-0">
      <svg xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" viewBox="0 0 1161.727 456.805">
        <defs>
          <clipPath id="a">
            <path
          ...
          <linearGradient id="l" x1="-0.238" y1="-0.291" x2="0.984" y2="1.019" xlinkHref ="#j" />
          ...
          <linearGradient id="q" x1="0.194" y1="-0.251" x2="0.857" y2="0.366" xlinkHref="#j" />
          <clipPath id="r">
            <path
          ...
          <linearGradient id="s" x1="0.698" y1="0.98" x2="0.324" y2="0.098" xlinkHref="#h" />
          <clipPath id="t">
            <path
          ...
          <linearGradient id="u" x1="0.731" y1="0.821" x2="0.286" y2="0.046" xlinkHref="#f" />
          <clipPath id="v">
            <path
          ...
          <linearGradient id="w" x1="0.501" y1="1.161" x2="0.484" y2="-0.939" xlinkHref="#d" />
          <clipPath id="x">
            <path
          ...
          <linearGradient id="y" x1="-0.027" y1="1.092" x2="0.759" y2="0.401" xlinkHref="#f" />
          <clipPath id="z">
            <path
          ...
          <linearGradient id="aa" x1="0.737" y1="0.976" x2="0.277" y2="0.117" xlinkHref="#h" />
          <clipPath id="ab">
            <path
          ...
          <linearGradient id="ac" x1="0.736" y1="0.722" x2="0.264" y2="0.157" xlinkHref="#f" />
